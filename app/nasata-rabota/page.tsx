      ...
      content: (
        <div key="content-2026">
          ...
          <div className="grid grid-cols-2 gap-4">
            <Image
              src={SITE_IMAGES.portfolio.residential[0]}
            ...
            />
            <Image
              src={SITE_IMAGES.portfolio.residential[1]}
            ...
            />
            <Image
              src={SITE_IMAGES.portfolio.residential[2]}
            ...
            />
            <Image
              src={SITE_IMAGES.portfolio.residential[3]}
    ...
    },
    {
      ...
      content: (
        <div key="content-2025">
          ...
          <div className="grid grid-cols-2 gap-4">
            <Image
              src={SITE_IMAGES.portfolio.commercial[0]}
            ...
            />
            <Image
              src={SITE_IMAGES.portfolio.commercial[1]}
            ...
            />
            <Image
              src={SITE_IMAGES.portfolio.commercial[2]}
            ...
            />
            <Image
              src={SITE_IMAGES.portfolio.commercial[3]}
