  ...
  return (
    <form onSubmit={onSubmit} className={`${wrapperBg} p-6 text-kl-ink`}>
      ...
      <button
        type="submit"
        disabled={submitting}
        className="mt-3 block h-12 w-full bg-kl-accent text-[14px] font-medium tracking-wide text-kl-ink transition-colors duration-100 hover:bg-kl-accent-strong disabled:opacity-60"
      >
