  ...
  return (
    <form onSubmit={onSubmit} className={`${wrapperBg} p-6 text-kl-ink`}>
      ...
      <button
        type="submit"
        disabled={submitting}
        className="mt-3 block h-12 w-full bg-black text-[14px] font-medium tracking-wide text-white transition-colors duration-100 hover:bg-black/85 disabled:opacity-60"
      >
